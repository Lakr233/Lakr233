...
| [SpeedBall](https://github.com/Lakr233/SpeedBall) | `App` | `MIT` | `Swift` | Full product structure, module boundaries, and interaction flow. | Bring back the old 90's floating speed ball to your Mac with some how morden design. |
